...
if FLAGS.dataset_name == 'auto':
    tf.app.flags.DEFINE_string('train_data_paths',
                           '/workspace/data/auto-train-front.npz',
                           'train data paths.')
    tf.app.flags.DEFINE_string('valid_data_paths',
                           '/workspace/data/auto-validatie-front.npz',
                           'validation data paths.')
    tf.app.flags.DEFINE_string('test_data_paths',
                           '/workspace/data/auto-test-front-l4.npz',
                           'test data paths.')
else:
    tf.app.flags.DEFINE_string('train_data_paths',
    ...
    tf.app.flags.DEFINE_string('valid_data_paths',
                           ...
                           'validation data paths.')
tf.app.flags.DEFINE_string('save_dir', '/workspace/checkpoints-front',
                            'dir to store trained net.')
tf.app.flags.DEFINE_string('gen_frm_dir', '/workspace/results-front',
                           'dir to store result.')
# model
tf.app.flags.DEFINE_string('model_name', 'predrnn_pp',
                           'The name of the architecture.')
tf.app.flags.DEFINE_string('pretrained_model', '/workspace/checkpoints-front/model.ckpt-60000',
